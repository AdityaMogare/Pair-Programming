"""
Config & deployment — intentionally incomplete / buggy starting line.
...
def run(payload: dict[str, Any]) -> dict[str, Any]:
    ...
    raise NotImplementedError("12-config-deployment is scaffolded — add buggy implementation next")
