"""
Payment transaction — intentionally incomplete / buggy starting line.
...
def run(payload: dict[str, Any]) -> dict[str, Any]:
    ...
    raise NotImplementedError("04-payment-transaction is scaffolded — add buggy implementation next")
