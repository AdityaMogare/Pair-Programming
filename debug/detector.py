...
Spec (same as the main exercise, all three phases):
...
Your job: make `python3 -m debug.test_detector` pass.
Do not peek at debug/BUGS.md until you've tried.
"""
...
SENSITIVE_ACTIONS = frozenset({"token.exfill", "secret.read"})
OFF_HOURS_START = 9
OFF_HOURS_END = 18
FREQ_THRESHOLD = 3
MAX_SEVERITY = 3
