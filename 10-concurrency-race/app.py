"""
Concurrency race — intentionally incomplete / buggy starting line.
...
def run(payload: dict[str, Any]) -> dict[str, Any]:
    ...
    raise NotImplementedError("10-concurrency-race is scaffolded — add buggy implementation next")
