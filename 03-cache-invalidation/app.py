"""
Cache invalidation — intentionally incomplete / buggy starting line.
...
def run(payload: dict[str, Any]) -> dict[str, Any]:
    ...
    raise NotImplementedError("03-cache-invalidation is scaffolded — add buggy implementation next")
